...
Batasan lain adalah tidak adanya interaktivitas berbasis data, seperti filter project berdasarkan kategori atau form kontak yang benar-benar bisa mengirim pesan (form hanya bisa berupa tampilan visual atau menggunakan `mailto:` sebagai solusi sementara).
